    ...
    <>
      <div style={{ background: '#EEF3FA', borderRadius: 13, border: '1.5px solid #185FA5', padding: 18, display: 'flex', flexDirection: 'column', gap: 14 }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
          ...
          <div>
            <div style={{ fontFamily: 'var(--font-outfit),sans-serif', fontWeight: 700, fontSize: 21, color: '#0D1B2E', lineHeight: 1.2 }}>
              Composite Paper
            </div>
            <div style={{ fontSize: 18, color: '#4A5E78', marginTop: 3, lineHeight: 1.4 }}>
        ...
        <button
          ...
          style={{
            ...
            fontFamily: 'var(--font-outfit),sans-serif', fontSize: 20, fontWeight: 700,
        ...
        {practiceLinks.length > 0 && (
          <div style={{ borderTop: '1px solid #D4E1F0', paddingTop: 12 }}>
            <p style={{ fontSize: 17, color: '#4A5E78', marginBottom: 8 }}>Or practise by subject:</p>
            <div style={{ display: 'flex', gap: 7, flexWrap: 'wrap' }}>
              {practiceLinks.map(l => (
                <Link
                  ...
                  href={l.href}
                  style={{
                    fontSize: 18, fontWeight: 500, padding: '5px 12px', borderRadius: 20,
      ...
      {showModal && (
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: 20, color: '#4A5E78', marginBottom: 22 }}>
            ...
            {mode === 'mock' && !subscribed && (
              <div style={{ marginBottom: 14, padding: '8px 12px', background: '#FEF4DC', border: '1px solid #EF9F27', borderRadius: 8, fontSize: 18, color: '#9A6000' }}>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 12, fontFamily: 'var(--font-outfit),sans-serif', fontSize: 23, fontWeight: 700,
